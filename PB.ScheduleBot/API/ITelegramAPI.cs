...
namespace PB.ScheduleBot.API {
    ...
    {
        Task EditInlineMessageTextAsync(string inline_message_id, string text, string parse_mode = "HTML", bool? disable_web_page_preview = null, object reply_markup = null);
        ...
        Task DeleteMessageForChatAsync(long chat_id, long message_id);
    }
}